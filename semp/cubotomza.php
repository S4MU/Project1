    ...
    <div class="container">
		...
		<div class="panel-heading">
           ...
           somefunction(this, event); return true;" class="btn btn-info"><span class="glyphicon glyphicon-plus" ></span>Exportar a excel</a>
			...
			<h4><i class='glyphicon glyphicon-search'></i> Reporte Cubo - Gerente Rodolfo Pacheco</h4>
		</div>
  ...
  <label for="q" class="col-md-4 control-label">Filtro:</label>
							...
							<option value="992">Total abajo de</option>
							  ...
							  <optgroup label="Cartago">
							    ...
							    <option value="14">Pulperias Rentabilidad 40/200</option>
	...
	<script type="text/javascript" src="js/VentanaCentrada.js"></script>
	  ...
	  <script>
         ...
         var cod = $("#codcliente").val();
          ...
          $('#loader').html('');
            window.open('http://tomzacr.com/semp/classes/cuboxls.php?d='+d+'&dd='+dd+'&q='+q+'&cod='+cod,'_blank' );
