...
FROM  $sTable WHERE ruta = '$q' AND fecha LIKE '%$d%' AND tipo = '100' GROUP BY fecha ORDER BY id ASC LIMIT $offset,$per_page ";
		...
		$kilos = 0;
				...
				$telefono_cliente .= '   -   '. $row['descuentot'];//($kilos * $telefono_cliente);
