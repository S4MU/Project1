    ...
    <div class="container">
		...
		<div class="panel-heading">
           ...
           somefunction(this, event); return true;" class="btn btn-info"><span class="glyphicon glyphicon-plus" ></span>Exportar a excel</a>
			...
			<h4><i class='glyphicon glyphicon-search'></i> Captura General</h4>
		</div>
	...
	<script type="text/javascript" src="js/VentanaCentrada.js"></script>
	  ...
	  <script>
         ...
         var d= $("#d").val();
          ...
          $('#loader').html('');
            window.open('http://tomzacr.com/semp/classes/03formulas.php?d='+d,'_blank' );
